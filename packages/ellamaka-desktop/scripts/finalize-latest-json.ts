...
const releaseId = process.env.ELLAMAKA_RELEASE
if (!releaseId) throw new Error("ELLAMAKA_RELEASE is required")

const version = process.env.ELLAMAKA_VERSION
if (!version) throw new Error("ELLAMAKA_VERSION is required")
