...
export const Flag = {
  ...
  ELLAMAKA_DISABLE_AUTOUPDATE: truthy("ELLAMAKA_DISABLE_AUTOUPDATE"),
  ELLAMAKA_ALWAYS_NOTIFY_UPDATE: truthy("ELLAMAKA_ALWAYS_NOTIFY_UPDATE"),
  ...
  ELLAMAKA_SERVER_PASSWORD: process.env["ELLAMAKA_SERVER_PASSWORD"],
  ELLAMAKA_SERVER_USERNAME: process.env["ELLAMAKA_SERVER_USERNAME"],
  ...
  // the desktop sidecar (DESIGN-dsh-base.md, constraint #11).
  get ELLAMAKA_DSH() {
