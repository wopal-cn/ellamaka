import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@wopal/ellamaka-core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
