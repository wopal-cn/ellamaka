import type { JsonSchema, LLMRequest, ProviderMetadata } from "@wopal/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@wopal/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @wopal/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
