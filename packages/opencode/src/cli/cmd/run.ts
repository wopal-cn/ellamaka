...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@wopal/ellamaka-sdk/v2"
  ...
  builder: (yargs: Argv) =>
    yargs
      ...
      .option("password", {
        alias: ["p"],
        type: "string",
        describe: "basic auth password (defaults to ELLAMAKA_SERVER_PASSWORD)",
      })
      .option("username", {
        alias: ["u"],
        type: "string",
        describe: "basic auth username (defaults to ELLAMAKA_SERVER_USERNAME or 'ellamaka')",
      })
      .option("dir", {
        type: "string",
