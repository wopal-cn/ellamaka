...
export const dict = {
  ...
  "workbench.chat.injection": "上下文注入",
  ...
  "workbench.runtime.unauthorizedTitle": "认证失败",
  "workbench.runtime.unauthorizedHint": "此服务器的已保存凭据被拒绝，请更新凭据以重新连接。",
  "workbench.runtime.unauthorizedAction": "更新服务器凭据",
