...
export function initWorkbenchState() {
  ...
  const setPersistentHint = (message: string) => {
    timedMessage(
      ...
      persistentHintTimer,
      (value) => {
        persistentHintTimer = value
      },
      setPersistentHintValue,
      "legacy-persistent-hint",
    )
  }
  ...
  const state = {
    ...
    get activeDirectory() {
      return workbench.activeDirectory
    },
    get activeTabPath() {
      return workbench.activeTabPath
    },
    get activeSpaceName() {
      return workbench.activeSpaceName
    },
