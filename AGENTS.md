...
- **Authority**: [logging design](./docs/DESIGN-logging.md) is the detailed logging policy (routing, files, channels, DSH classification, trace categories, redaction). Update it in the same change as any logging-behavior edit
